import{g as l}from"./index-Wwh301DR.js";function s(o,c){for(var a=0;a<c.length;a++){const n=c[a];if(typeof n!="string"&&!Array.isArray(n)){for(const e in n)if(e!=="default"&&!(e in o)){const r=Object.getOwnPropertyDescriptor(n,e);r&&Object.defineProperty(o,e,r.get?r:{enumerable:!0,get:()=>n[e]})}}}return Object.freeze(Object.defineProperty(o,Symbol.toStringTag,{value:"Module"}))}var t={exports:{}};(function(o,c){ace.define("ace/theme/mono_industrial-css",["require","exports","module"],function(a,n,e){e.exports=`.ace-mono-industrial .ace_gutter {
  background: #1d2521;
  color: #C5C9C9
}
