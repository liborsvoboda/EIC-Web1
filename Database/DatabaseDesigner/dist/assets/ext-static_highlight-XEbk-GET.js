import{g as P}from"./index-Wwh301DR.js";function D(m,b){for(var a=0;a<b.length;a++){const u=b[a];if(typeof u!="string"&&!Array.isArray(u)){for(const l in u)if(l!=="default"&&!(l in m)){const v=Object.getOwnPropertyDescriptor(u,l);v&&Object.defineProperty(m,l,v.get?v:{enumerable:!0,get:()=>u[l]})}}}return Object.freeze(Object.defineProperty(m,Symbol.toStringTag,{value:"Module"}))}var T={exports:{}};(function(m,b){ace.define("ace/ext/static-css",["require","exports","module"],function(a,u,l){l.exports=`.ace_static_highlight {
